...
return [
    ...
    'commitment' => [
        'heading' => 'SCHNELL, GÜNSTIG, QUALITATIV — WÄHLEN SIE ZWEI',
        'text'    => 'Jemand verspricht Ihnen eine Website, die gleichzeitig schnell, günstig und perfekt ist. Wählen Sie zwei — das dritte ist immer ein Verkaufstrick, den Sie erst auf der Rechnung bemerken.
...
Ich programmiere nicht mit WordPress. Keine Drittanbieter-Plugins, keine Sicherheitslücken, keine monatlichen Wartungsgebühren. Sie sparen auch an dem, was Sie nicht zahlen müssen.',
    ...
    'projects' => [
        'subheading' => 'Realisierte Projekte',
        'heading'    => 'Arbeitsbeispiele in der Praxis',
        'cta'        => 'Alle Projekte',
    ],

    'testimonials' => [
        'subheading'    => 'Kundenbewertungen',
        'heading'       => 'Was die sagen, für die ich gearbeitet habe',
        'reviews_label' => 'Bewertungen',
    ],

    'faq' => [
        'subheading' => 'Häufige Fragen',
