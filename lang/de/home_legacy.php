...
/*
|--------------------------------------------------------------------------
| PŮVODNÍ HOMEPAGE — zmrazená kopie textů (OND-306)
|--------------------------------------------------------------------------
| DOČASNÉ LEŠENÍ. Kopie `lang/de/home.php` ke dni 23. 9. 2026 pro
| stránku `/puvodni-homepage` (viz `resources/views/pages/home-legacy.blade.php`).
| Slouží jen k porovnání staré a nové homepage během přestavby (OND-305).
|
| NEUDRŽOVAT. Texty se sem nepropisují — `home.php` se přepisuje nezávisle.
| Až Ondřej novou homepage odsouhlasí, tenhle soubor se smaže.
*/
