...
<section class="bg-mx-black section-lg">
  <div class="page-container">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3" data-lg-gallery>
      @foreach ($miroslav202306 as $item)
      <a class="lg-item" href="../{{ $item->href_big }}">
        <img src="../{{ $item->src_small }}" loading="lazy" alt="Galerie - {{ $thisCat }}" class="w-full aspect-video object-cover rounded-lg hover:opacity-90 transition-opacity">
      </a>
      @endforeach
    </div>
