...
return[
"allinone" => "
	<p>Effective date: July 28, 2023</p>
	<p>itwebtech (Ondrej Kriska) operates the website (the “Service“).</p>
	<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use
	our Service and the choices you have associated with that data. Our Privacy Policy for itwebtech is created with
	the help.</p>
	...
	<p>If you are located outside Czech Republic and choose to provide information to us, please note that we transfer
	the data, including Personal Data, to Czech Republic and process it there.</p>
	<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
	that transfer.</p>
	<p>itwebtech will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
	...
	<p>itwebtech may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
	<ul>
	<li>To comply with a legal obligation</li>
	<li>To protect and defend the rights or property of itwebtech</li>
	...
	<ul>
	<li>
	<p><strong>Google Analitics</strong></p>
	<p>Google Analitics is a web analytics service. Read the Privacy Policy for Google Analitics</p>
	</li>
	</ul>
	...
	<p>We may update our Privacy Policy from time to time. We will notify you of any changes on this page.</p>
	<p>We will let you know via a prominent notice on our Service, prior to the change becoming effective
